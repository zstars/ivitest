...
# Originally: scope.channels[0]
scope.trigger.source = scope.channels[0].name
...
print("PEAK TO PEAK VOLTAGE: {}".format(vpp))

# measure phase
# Used to be scope.channels[1]
phase = scope.channels[0].measurement.fetch_waveform_measurement("phase", scope.channels[1].name)
